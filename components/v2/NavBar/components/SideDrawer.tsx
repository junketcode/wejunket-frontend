  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <p className="w-full pt-24 font-sans uppercase text-center text-black p-2 mb-6">
        ...
        <div key="Login" className="w-full h-12 flex justify-center align-middle text-center hover:bg-gray-400">
          <a key="Login" href="https://cms.wejunket.com" className="w-full align-middle text-black font-bold">Login</a>
        </div>
      </div>
    </React.Fragment>
  )
